...
class SuccessCommunityJoinedScreen extends StatelessWidget {
  const SuccessCommunityJoinedScreen({Key? key}) : super(key: key);
          ...
          Column(
            ...
            children: [
              Padding(
                ...
                child: Center(
                  child: SvgPicture.asset("assets/backgrounds/community/party-success2.svg"),
                ),
              ),
              const Padding(
