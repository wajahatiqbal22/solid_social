    ...
    return Padding(
      ...
      child: Ink(
        ...
        child: Column(
          ...
          children: [
            _settingOption(leftIcon: CustomIcons.help(), label: "Help / Support", iconRight: null, onPressed: () {}),
            const Divider(
              indent: 15,
              endIndent: 15,
            ),
            _settingOption(leftIcon: CustomIcons.exit(), label: "Exit Group", iconRight: null, onPressed: () {}),
          ],
        ),
      ),
    );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              Navigator.popAndPushNamed(context, AppRouter.editGroupChat);
            },
            child: Container(
